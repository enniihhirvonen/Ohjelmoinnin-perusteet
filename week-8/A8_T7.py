    ...
    while True:
        ...
        match choice:
            ...
            case 3:
                ...
                middleX = int(askValue1("Middle point X"))
                middleY = int(askValue1("Middle point Y"))
                apothem = int(askValue1("Apothem length"))
                color = askValue1("Fill color")
                stroke = askValue1("Stroke stroke")
                drawHexagon(Dwg, middleX, middleY, apothem, color, stroke)
